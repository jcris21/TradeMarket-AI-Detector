...
- [ ] 4.1 Run the focused backend tests for ScoringAgent and orchestrator analysis behavior.
- [ ] 4.2 Run OpenSpec validation/status for `tech-005-guardrail-validator`.
